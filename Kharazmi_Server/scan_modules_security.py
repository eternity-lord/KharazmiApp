...
# We will scan routers: homework, messages, exams
target_prefixes = ["/homework", "/messages", "/exams", "/students/{student_id}/report_card"]
...
def scan_security():
    ...
    print("=========================================================================")
    print("📋 SECURITY ACCESS LEVEL AUDIT FOR THREE CRITICAL MODULES")
    print("=========================================================================")
